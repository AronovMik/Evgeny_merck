...
## Устаревшие редакции — `superseded/`

Замещённые редакции гайдлайнов лежат в подпапке [`superseded/`](./superseded/). **Это не источник истины** — использовать только при явной необходимости (сверка старой ссылки спикера, показ эволюции позиции) и **всегда с пометкой «superseded»** в выводе. Политика — в [`superseded/README.md`](./superseded/README.md).

| Файл | Тема | Год | Замещён |
|---|---|---|---|
| `superseded/ESC_2019_CCS__SUPERSEDED.pdf` | Chronic Coronary Syndromes | 2019 | ESC 2024 CCS (актуальная редакция — в основной библиотеке / main) |
