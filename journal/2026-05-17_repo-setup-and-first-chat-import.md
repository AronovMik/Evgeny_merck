...
## Дополнение в той же сессии — индекс чатов

- Создан `archive/claude-chats/PREVIOUS_CHATS.md` — короткий индекс всех перенесённых чатов с темами, препаратами, гайдлайнами, установленными принципами и условиями подгрузки. Заполнена первая запись по чату «Клинические случаи».
- `CLAUDE.md`: в session-start workflow добавлен шаг «просмотреть PREVIOUS_CHATS.md»; в end-of-session — шаг «при переносе нового чата добавить запись в PREVIOUS_CHATS.md».
- `archive/claude-chats/README.md`: добавлена ссылка на индекс.
- **Правило:** Claude читает индекс при старте, но **файлы чатов открывает только по явной команде** Евгения («подтяни чат про…»). Это исключает «съедание» контекста на ненужные архивы.

## Что осталось / следующий шаг
- Дождаться следующих чатов из claude.ai и перенести их в `archive/claude-chats/`, обновив `PREVIOUS_CHATS.md`.
